...
import mapimglight from '/mapimglight.png'
  ...
  return (
    <div className='flex flex-col items-center justify-center h-screen overflow-hidden'>
        <div className='flex flex-col items-center justify-center h-screen'>
            <div>
                <img src={mapimgdark} alt="map-img" className='block dark:hidden'/>
                <img src={mapimglight} alt='map-img' className='hidden dark:block'/>
            </div>
            ...
            <div className='mt-4'>
                <button onClick={() => setSelectLocation(true)} className='w-[90vw] bg-[#12352420] dark:bg-white text-black p-4 flex items-center justify-center rounded-3xl'>
