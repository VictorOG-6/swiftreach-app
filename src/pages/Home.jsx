      ...
      <div>
        ...
        <div className='pt-2'>
          <div className='flex justify-around items-center mb-4'>
            <Link to='/createorder' className='flex flex-col items-center border border-black rounded-3xl p-2 shadow-lg'>
          ...
          <div className='flex justify-around items-center'>
            <Link to='/createorder' className='flex flex-col items-center border border-black rounded-3xl p-2 shadow-lg'>
              <img src={scooterimgdark} alt="scooter-image" className='w-40 h-24 object-cover'/>
              <h5>Scooter</h5>
            </Link>            
          </div>
        </div>  
