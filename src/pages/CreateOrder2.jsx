...
const CreateOrder2 = () => {
  return (
    <div className='w-screen p-4'>
        ...
        <div className='flex flex-col items-center justify-around border border-black-200 shadow-md rounded-3xl p-4 mb-4'>
            <div className='flex justify-between w-[85vw] pb-4 border-b border-black-500'>
                <div>
            ...
            <div className='w-[85vw] flex justify-between pt-2 pb-4 border-b border-black-500'>
                <div>
                    <h3>Length</h3>
        ...
        <div className='mb-2'>
            <h3 className='mb-2'>Pick Up And Delivery</h3>
            <div className='flex flex-col items-center justify-around border border-black-200 shadow-md rounded-3xl p-4'>
                ...
                <div className='border border-black-200 shadow-md rounded-3xl py-2 px-4 mb-4'>
                    <h5>From</h5>
                    <h3 className='font-bold'>Audu Zuriel</h3>
                    <h5>28 Vikas Marg, Swasthybmya Vhar, Delhi 110092 </h5>
                    <h5>+91 9243165432</h5>
                </div>
                <div className='border border-black-200 shadow-md rounded-3xl py-2 px-4'>
                    <h5>To</h5>
        ...
        <Link to='/createorder3' className='w-[90vw] bg-black text-white p-4 flex items-center justify-center rounded-3xl'>
            <h1>Confirm</h1>
        </Link>               
    </div>
  )
