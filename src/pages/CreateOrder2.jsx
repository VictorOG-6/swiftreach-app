  ...
  return (
    <div className='w-screen p-4'>
        ...
        <div className='mb-2'>
            ...
            <div className='flex flex-col items-center justify-around border border-black-200 shadow-md rounded-3xl p-2'>
                <div className='mb-2'>
                    <h5 className='text-center'>Pick-up date and time</h5>
                    <h3 className='font-bold'>Wed, 10 Jan 2024, 10:00AM</h3>
                </div>
                <div className='border border-black-200 shadow-md rounded-3xl py-2 px-4 mb-2'>
                    <h5>From</h5>
